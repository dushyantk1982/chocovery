...
<div class="innerCotnLeft">
  ...
  <div class="promenu">
  <?php
  if($_REQUEST['cat']=='box_fs')
	{
		echo "<ul>
				<li><a href='apple.php?cat=box_fs' class='active'><span>Box FS</span></a></li>
				<li><a href='apple.php?cat=butter_box'><span>Butter Box</span></a></li>
				<li><a href='apple.php?cat=elichi'><span>Elichi</span></a></li>
				<li><a href='apple.php?cat=butter_toffee'><span>Butter Toffee</span></a></li>
				<li><a href='apple.php?cat=dil_se'><span>Dil Se</span></a></li>
				<li><a href='apple.php?cat=heart_candy'><span>Heart Candy</span></a></li>
			</ul>";
	}
else if($_REQUEST['cat']=='butter_box')
{
echo "<ul>
     	<li><a href='apple.php?cat=box_fs'><span>Box FS</span></a></li>
		<li><a href='apple.php?cat=butter_box' class='active'><span>Butter Box</span></a></li>
		<li><a href='apple.php?cat=elichi'><span>Elichi</span></a></li>
		<li><a href='apple.php?cat=butter_toffee'><span>Butter Toffee</span></a></li>
		<li><a href='apple.php?cat=dil_se'><span>Dil Se</span></a></li>
		<li><a href='apple.php?cat=heart_candy'><span>Heart Candy</span></a></li>
...
else if($_REQUEST['cat']=='elichi')
{
echo "<ul>
     	<li><a href='apple.php?cat=box_fs'><span>Box FS</span></a></li>
		<li><a href='apple.php?cat=butter_box'><span>Butter Box</span></a></li>
		<li><a href='apple.php?cat=elichi' class='active'><span>Elichi</span></a></li>
		<li><a href='apple.php?cat=butter_toffee'><span>Butter Toffee</span></a></li>
		<li><a href='apple.php?cat=dil_se'><span>Dil Se</span></a></li>
		<li><a href='apple.php?cat=heart_candy'><span>Heart Candy</span></a></li>
      </ul>";
}
else if($_REQUEST['cat']=='butter_toffee')
{
echo "<ul>
     	<li><a href='apple.php?cat=box_fs'><span>Box FS</span></a></li>
		<li><a href='apple.php?cat=butter_box'><span>Butter Box</span></a></li>
		<li><a href='apple.php?cat=elichi'><span>Elichi</span></a></li>
		<li><a href='apple.php?cat=butter_toffee' class='active'><span>Butter Toffee</span></a></li>
		<li><a href='apple.php?cat=dil_se'><span>Dil Se</span></a></li>
		<li><a href='apple.php?cat=heart_candy'><span>Heart Candy</span></a></li>
      </ul>";
}
else if($_REQUEST['cat']=='dil_se')
{
echo "<ul>
     	<li><a href='apple.php?cat=box_fs'><span>Box FS</span></a></li>
		<li><a href='apple.php?cat=butter_box'><span>Butter Box</span></a></li>
		<li><a href='apple.php?cat=elichi'><span>Elichi</span></a></li>
		<li><a href='apple.php?cat=butter_toffee'><span>Butter Toffee</span></a></li>
		<li><a href='apple.php?cat=dil_se' class='active'><span>Dil Se</span></a></li>
		<li><a href='apple.php?cat=heart_candy'><span>Heart Candy</span></a></li>
      </ul>";
}
...
echo "<ul>
		...
		<li><a href='apple.php?cat=butter_toffee'><span>Butter Toffee</span></a></li>
		<li><a href='apple.php?cat=dil_se'><span>Dil Se</span></a></li>
		<li><a href='apple.php?cat=heart_candy' class='active'><span>Heart Candy</span></a></li>
	</ul>";
...
<h1>Box FX</h1>
  ...
  <ul>
<li>
<a href="gallery/apple/" rel="example2" title="Product Name : Grapes"><img src="gallery/apple" alt="" /></a>
<span>Name</span>
</li>
...
<h1>Butter Toffee</h1>
  ...
  <ul>
<li>
<a href="gallery/apple/IMG-20150728-WA0013 - copy.jpg" rel="example2" title="Product Name : Grapes"><img src="gallery/apple/IMG-20150728-WA0013 - copy.jpg" alt="" /></a>
...
else if($_REQUEST['cat']=='heart_candy')
{
?>
<h1>Heart Candy</h1>
  <div class="catagallery">
