...
$howemployee = $_POST['howemployee'];
$iexpe = $_POST['iexpe'];
$beadealer = $_POST['beadealer'];
$info = $_POST['info'];
$formcontent=" From: $name \n Company Name : $cname \n Nature of Business: $nob \n Date of Establishment: $doe \n Contact No. : $phone \n Email : $email \n Address: $address \n How many Fulltime employees does your company/firm have: $howemployee \n Industry Experience: $iexpe \n Please tell us the reason you want to be a Dealer: $beadealer \n Any other vital information: $info";
$recipient = "adosurface@gmail.com, ado.surface@yahoo.com";
$subject = "Distributor Enquiry";
$mailheader = "From: $email \r\n";
mail($recipient, $subject, $formcontent, $mailheader) or die("Error!");
echo "Thank You for submitting your information..." . " <b style='font-size:14px;'>$name </b>" . "<br><br> Our representative will get in touch with you shortly...";
?>
</div>
