...
*/
   ...
   if (file_exists($tmp_name)){
	  ...
	  {
         echo "<div><center><h4>"."Thank You for submitting your information..." . " <b style='font-size:14px;'>$name </b>" . "<br><br> Our representative will get in touch with you shortly..."."</h4></center></div>";
	  }else
	  {
         ?>
         <div><center>
  			...
  			<div class="distri">
				...
				<div class="distriform">
					...
					<form id="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="frowright"><input type="text" name="name" id="name"></div>
						</div>

						<div class="frow">
						<div class="frowleft">Telephone / Mobile: <font class="redcolor">*</font></div>
						<div class="frowright"><input type="text" name="phone" id="phone"></div>
						</div>

						<div class="frow">
						<div class="frowleft">E-mail Id <font class="redcolor">*</font></div>
						<div class="frowright"><input type="text" name="email" id="email"></div>
						</div>

						<div class="frow">
						<div class="frowleft">Address: <font class="redcolor">*</font></div>
						<div class="frowright"><input type="text" name="address" id="address"></div>
						</div>
...
<div class="conRight">
<h1>Contact Us</h1>
<h2>Yashvi Agro Industries Pvt. Ltd.</h2>
<p>(An ISO 9001:2008 Certified Company)<br>
  Near Motilal Mill Compoud, Resham Mill Road, <br>
  Birla Nagar, Gwalior (M.P.) INDIA<br>
  <strong>Contact No.</strong> : +91 9827017152, 8989473785<br>
  <strong>Landline</strong> : +91 751 4071970<br>
  <strong>Email</strong> : adosurface@gmail.com, ado.surface@yahoo.com<br>
  <strong>Website</strong> : www.adosurface.com
  </p>
</div>-->
...
/*if ($_SERVER['REQUEST_METHOD']=="POST"){
   ...
   if (file_exists($tmp_name)){
      ...
      if (@mail($to, $subject, $message, $headers))
	  {
         echo "<div><center><h1>"."Thank You for submitting your information..." . " <b style='font-size:14px;'>$name </b>" . "<br><br> Our representative will get in touch with you shortly..."."</h1></center></div>";
	  }else
	  {
         ?>
         <div><center>
...
<!--<div class="clear"></div>
<div class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3579.618093170228!2d78.1597018765502!3d26.209098974029676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1421300141101" width="100%" height="350" frameborder="0" style="border:0"></iframe></div>
</div>-->
</div>
</div>
