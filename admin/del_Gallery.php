...
{
	echo "<h1>Digi Stone Dices Gallery</h1>";
 $conn=mysql_connect("166.62.8.3","adosurface","Admin@123");
	...
	while($r=mysql_fetch_array($res))
	{
		...
		echo "<span><a href='delete_gallery.php?name=".$r['name']."&cat=".$r['gallery_cat']."'>Delete</a></span>";
		echo "</li>";
	}
	echo "</ul>";
}
...
{
echo "<h1>Digi WPC Wall Gallery</h1>";
 $conn=mysql_connect("166.62.8.3","adosurface","Admin@123");
	if(!$conn)
		{die("Could Not Connect".mysql_error());}
	mysql_select_db('adosurface');
	echo "<ul>";
	$res=mysql_query("select * from gallery where gallery_cat='Digi_WPC_Wall_Gallery' order by '".DECS."'",$conn);
	while($r=mysql_fetch_array($res))
	{
		echo "<li>";
		echo "<a href='../photo_gallery/wpc_wall/".$r['name']."' rel='example2' title='Product Code : '".$r['product_code']."'><img src='../photo_gallery/wpc_wall/".$r['name']."' alt='' /></a>";
		echo "<span><a href='delete_gallery.php?name=".$r['name']."&cat=".$r['gallery_cat']."'>Delete</a></span>";
		echo "</li>";
	}
	echo "</ul>";
...
{
echo "<h1>Live Project Gallery</h1>";
 $conn=mysql_connect("166.62.8.3","adosurface","Admin@123");
	if(!$conn)
		{die("Could Not Connect".mysql_error());}
	mysql_select_db('adosurface');
	echo "<ul>";
	$res=mysql_query("select * from gallery where gallery_cat='Live_Project_Gallery' order by '".DECS."'",$conn);
	while($r=mysql_fetch_array($res))
	{
		echo "<li>";
		echo "<a href='../photo_gallery/live_project/".$r['name']."' rel='example2' title='Product Code : '".$r['product_code']."'><img src='../photo_gallery/live_project/".$r['name']."' alt='' /></a>";
		echo "<span><a href='delete_gallery.php?name=".$r['name']."&cat=".$r['gallery_cat']."'>Delete</a></span>";
		echo "</li>";
	}
	echo "</ul>";
...
{
	echo "<h1>Digi Doors Gallery</h1>";
 $conn=mysql_connect("166.62.8.3","adosurface","Admin@123");
	if(!$conn)
		{die("Could Not Connect".mysql_error());}
	mysql_select_db('adosurface');
	echo "<ul>";
	$res=mysql_query("select * from gallery where gallery_cat='Digi_Doors_Gallery' order by '".DECS."'",$conn);
	while($r=mysql_fetch_array($res))
	{
		echo "<li>";
		echo "<a href='../photo_gallery/doors/".$r['name']."' rel='example2' title='Product Code : '".$r['product_code']."'><img src='../photo_gallery/doors/".$r['name']."' alt='' /></a>";
		echo "<span><a href='delete_gallery.php?name=".$r['name']."&cat=".$r['gallery_cat']."'>Delete</a></span>";
		echo "</li>";
	}
	echo "</ul>";
